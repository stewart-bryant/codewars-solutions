...
function race(v1, v2, g) {
    ...
    //When the 2nd tortoise leaves, the 1st tortoise has an “advantage” of g ft. The difference in velocities is v2 - v1 ft/hr, and the 2nd tortoise will need g ft/vd ft/hr hrs to cover that gap. 
