...
function computeDepth (x){
    ...
    let i = 1;
    do {
      //start by multiplying by 1, then loop until all digits are in the digits array
      let product = (x * i).toString().split('');
        //if digits array does not include the digits from the product, push that digit into the array
      ...
      i++;
    } while (digits.sort().join('') != '0123456789');
    return i-1;
  }